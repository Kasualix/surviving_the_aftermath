...
public class NetherRaidEventSubscriber {
    ...
    public static final String NETHER_RAID_START = "message.nether_raid.nether_raid.start";
    public static final String NETHER_RAID_VICTORY = "message.nether_raid.nether_raid.victory";
