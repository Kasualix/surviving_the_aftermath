...
import mod.nether_raid.structure.BurntStructure;
import mod.nether_raid.structure.CityStructure;
import mod.nether_raid.structure.HouseOfSakura;
import mod.nether_raid.structure.NetherRaidStructure;
import mod.nether_raid.structure.expansion.*;
...
public class ModStructurePieceTypes {
	...
	public static final DeferredRegister<StructurePieceType> STRUCTURE_PIECE_TYPES = DeferredRegister.create(Registries.STRUCTURE_PIECE.location(), Main.MODID);
